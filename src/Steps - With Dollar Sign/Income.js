...
export const Income = () => {
  ...
  const InterestData = [];
  const [values, setValues] = useState(["", "", "", ""]); // Assuming you have 3 inputs
  /* For Loop */
  const [values1, setValues1] = useState({ input10: "", input20: "", input30: "",input11: "", input21: "", input31: "",input12: "", input22: "", input32: "", input13: "", input23: "", input33: "", input14: "", input24: "", input34: "", input15: "", input25: "", input35: "", input16: "", input26: "", input36: "" });
  /* End For Loop */
  ...
  /* For Loop */
  const keyPressHandler1 = (event, inputName) => {
    const { key } = event;
  ...
  const keyPressHandler = (event, index) => {
    ...
    setValues(prevValues => {
      const newValue =
        key !== "Backspace"
          ? !Number.isNaN(parseInt(key)) || key === "," || key === "."
            ? prevValues[index] + key
            : prevValues[index]
          : prevValues[index].substring(0, prevValues[index].length - 1);
    ...
    <div class="w4-main-container">
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="text"
                    id="InterestIncome"
					onKeyDown={(event) => keyPressHandler(event, 0)}
          placeholder={currencyFormat.format("")}
          value={values[0] !== "" ? currencyFormat.format(values[0]) : ""}
                  />
      ...
      {showDividendIncome && (
        ...
        >
          ...
          placeholder={currencyFormat.format("")}
          value={values[1] !== "" ? currencyFormat.format(values[1]) : ""}
                  />
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
					...
					onKeyDown={(event) => keyPressHandler(event, 2)}
          placeholder={currencyFormat.format("")}
          value={values[2] !== "" ? currencyFormat.format(values[2]) : ""}
                  />
		    ...
		    {InterestData.map((interest, index) => (
				<div key={index} class="jobs-panel">
				  ...
				  <ul class="selection-panel">
					<li>
					  <div class="tool-input position-relative my-2">
						<input type="text" onKeyDown={(event) => keyPressHandler1(event, `input1${index}`)} placeholder={currencyFormat.format("")} value={values1[`input1${index}`] !== "" ? currencyFormat.format(values1[`input1${index}`]) : ""} {...register(`netprofit-${index + 1}`)} id={`Netprofit-${index + 1}`} />
						<label for={`Netprofit-${index + 1}`}>Net Profit </label>
					  </div>
					</li>
					<li>
					  <div class="tool-input position-relative my-2">
						<input type="text" onKeyDown={(event) => keyPressHandler1(event, `input2${index}`)} placeholder={currencyFormat.format("")} value={values1[`input2${index}`] !== "" ? currencyFormat.format(values1[`input2${index}`]) : ""} {...register(`eqp-${index + 1}`)}  id={`EQP-${index + 1}`} />
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
					...
					onKeyDown={(event) => keyPressHandler(event, 3)}
          placeholder={currencyFormat.format("")}
          value={values[3] !== "" ? currencyFormat.format(values[3]) : ""}
                    type="text"
                    id="Unemployment"
