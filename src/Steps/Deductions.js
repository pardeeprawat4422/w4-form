...
export const Deductions = () => {
  ...
  const {
	...
	const checkboxvalue = (e) => {
		...
		document.getElementById("Studentloaninterest").checked = false;
        document.getElementById("IRAcontributions").checked = false;
		};	
	const Uncheckeed = () => {
		const checkboxIds = [
		"Studentloaninterest",
...
return (
	...
	{saveDeduction && (
     <Form
        ...
        >
		<h2 class="text-center font-weight-bold">Do you want to take the standard <br/> deduction? </h2>
			<p class="text-center">Select "Yes" if you're not claiming itemized deductions.</p>
			<div class="status-panel">
				<ul class="selection-panel mt-5 p-4">
					<li>
						<div class="form-check py-3">
							<input  {...register("standarddeduction", { required: "Please select an option" })} value="Yes" type="radio" class="form-check-input"  id="validationCustom01 " />
							<label class="form-check-label single yes">
								Yes
							</label>
						</div>
					</li>
					<li>
						<div class="form-check py-3">
							<input  {...register("standarddeduction", { required: "Please select an option" })}  value="No" type="radio" class="form-check-input"  id="validationCustom02 " />
					 ...
					 {errors.standarddeduction && <p class="text-center mt-5"><span class="error_msg text-danger mx-auto mt-5">{errors.standarddeduction.message}</span></p>}
				</ul>
			</div>
			<div class="form-footer mt-5 pt-4 text-center">
			    <button class="btn btn-w4-success Previousform" onClick={PreviousStepToCredits}>previous</button>
	  ...
	  {saveDeductionApply && (
		 <Form
			...
			<h2 class="text-center font-weight-bold">
			  ...
			  <div class="form-footer mt-5 pt-4 text-center">
			  <button class="btn btn-w4-success Previousform" onClick={PreviousDeductionApplyData}>previous</button>
				<button class="btn btn-primary">Next</button>
			  </div>
			</Form>
      )}
	   {saveStudentApply && (
		 <Form
          ...
          <p class="text-center">Include student loan interest amounts for you, your spouse, and/or your dependent(s).</p>
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="" id="StudentApplyIncomee">
                    Student loan interest
                  </label>
                </div>
              </li>
	   ...
	   {saveIRAcontributions && (
		 <Form
			...
			>
			 <h2 class="text-center font-weight-bold">Eligible IRA contributions</h2>
          <p class="text-center">Include traditional IRA contributions eligible for a deduction.</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
	  ...
	  {/* No code Here */ }
	   {saveNoDeductionApply && (
		 <Form
			...
			<h2 class="text-center font-weight-bold">
			  ...
			  <p class="text-center">
				This calculator accounts for the most common tax situations. Choose "Other deductions" if yours is not listed.
			  </p>
			  <div class="status-panel">
	    ...
	    {savehomemortgage && (
		 <Form
          ...
          <p class="text-center">Include mortgage interest for your main or second home and points paid to buy a home.</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="homemortgage" id="homemortgageIncomee">
                    Mortgage interest
                  </label>
                </div>
              </li>
	   ...
	   {saveCharitabledonations && (
		 <Form
			...
			>
			 <h2 class="text-center font-weight-bold">2023 donations</h2>
          <p class="text-center">Include money or property donations made to qualified organizations.$0</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="Charitabledonations" id="Charitabledonations">
                    2023 donations
                  </label>
                </div>
              </li>
	  ...
	  {saveStateIncome && (
		 <Form
          ...
          <p class="text-center">xamples include state and local, real estate, and/or personal property taxes.</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="StateIncome" id="StateIncome">
	  ...
	  {saveMedicalexpenses && (
		 <Form
			...
			>
			 <h2 class="text-center font-weight-bold">Total anticipated medical expenses</h2>
          <p class="text-center">Enter the total of all eligible, unreimbursed medical and dental expenses. Examples include prescriptions, exams, and qualified long-term care.</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="Medicalexpenses" id="Medicalexpenses">
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="Studentloaninterestno" id="Studentloaninterestno">
                   Student loan interest
                  </label>
                </div>
              </li>
              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="IRAcontributionsno" id="IRAcontributionsno">
                   Eligible IRA contributions
                  </label>
                </div>
              </li>
	  ...
	  {saveOtherdeductions && (
		 <Form
          ...
          <p class="text-center">Examples include deductible theft and disaster losses and impairment-related work expenses.</p>
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    type="number"
                  />
                  <label for="Otherdeductions" id="Otherdeductions">
                  Other deductions
                  </label>
                </div>
              </li>
