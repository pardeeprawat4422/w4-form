...
return (
	...
	{showdependents && ( 
			<Form  id="steps-2" class="tab-wizard wizard-circle wizard clearfix" onSubmit={handleSubmit(showdependentsData)}>
                    ...
                    <div key={index} class="jobs-panel">
                        <div class="add-jobs">
                            <div class="edit-heading mb-3 w-100">
                                <h2 id="editable" onclick="makeEditable(this)">{dependent.name}</h2>
                            </div>
                        ...
                        <ul class="selection-panel">
                            <li>
                                <div class="tool-input position-relative my-2" >
                                    <input type="text" placeholder="$0" {...register(`dependents-${index + 1}`, { required: "Please select an option" })} />
                            ...
                            <li class="py-4">
                                <div class="check-panel">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Student" {...register(`dependentstype${index + 1}[]`)} />
                                        <label class="form-check-label" for="defaultCheck1">
                                            Student
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="Disabled" {...register(`dependentstype${index + 1}[]`)} />
                                        <label class="form-check-label" for="defaultCheck2">
                                            Disabled
                                        </label>
                                      </div>
                                      <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="LWM" {...register(`dependentstype${index + 1}[]`)} />
                    ...
                    <a class="add-job-btn" onClick={addNewDependent}>Add another job </a>
