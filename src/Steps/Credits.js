    ...
    <div class="w4-main-container">
      ...
      {showdependents && (
        ...
        >
          ...
          <p class="text-center">
            This helps us determine which dependent-related tax breaks you might qualify for. Examples include Earned Income Tax Credit, Child Tax Credit, and Credit for Other Dependents.
          </p>
        ...
        >
          ...
          <div class="jobs-panel">
            <ul class="selection-panel">
              <li>
                <div class="tool-input position-relative my-2">
                  <input type="text" onKeyDown={(event) => keyPressHandler(event, 0)} placeholder={currencyFormat.format("")} value={values[0] !== "" ? currencyFormat.format(values[0]) : ""} id="othercredit" />
