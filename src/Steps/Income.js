              ...
              <li>
                <div class="tool-input position-relative my-2">
                  <input
                    ...
                    id="InterestIncome"
                  />
                  <label for="InterestIncome">Age</label>
                </div>
              </li>
          ...
          <div id="container">
            <div class="jobs-panel">
              ...
              <ul class="selection-panel">
                <li>
                  <div class="tool-input position-relative my-2">
                    <input type="text" placeholder="$0" id="Netprofit" />
                    <label for="Netprofit">Net Profit </label>
                  </div>
                </li>
                <li>
                  <div class="tool-input position-relative my-2">
                    <input type="text" placeholder="$0" id="EQP" />
                    <label for="EQP">Estimated quarterly payments</label>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div class="jobs-panel new-div mt-5" id="template-div">
              ...
              <ul class="selection-panel">
                <li>
                  <div class="tool-input position-relative my-2">
                    <input type="text" placeholder="$0" id="Netprofit2" />
                    <label for="Netprofit2">Net Profit </label>
                  </div>
                </li>
                <li>
                  <div class="tool-input position-relative my-2">
                    <input type="text" placeholder="$0" id="EQP2" />
                    <label for="EQP2">Estimated quarterly payments </label>
                  </div>
                </li>
              </ul>
            </div>
